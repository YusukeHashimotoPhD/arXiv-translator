...
#    sort_by_text = 'Last updated date'
    dict_sort_by = {'Last updated date':arxiv.SortCriterion.LastUpdatedDate, 'Submitted date':arxiv.SortCriterion.SubmittedDate, 'Relevance':arxiv.SortCriterion.Relevance}
...
if len(df) != 0:
    ...
    st.subheader('Please choose the major and minor divisions of the reseach fields you want to investigate. Then, you will see infomation of papers submitted to arXiv.')
#    st.subheader('If you want to translate the documents, please input your apicheck the checkbox of left side of "translate?". Then you will see the translated documents.')
    st.subheader('If you want to translate the documents, please input your api-key code for the deepL API free obtained in https://www.deepl.com/en/pro/change-plan#developer. Then, check the checkbox of left side of "translate?". You will see the translated documents.')
    st.subheader('Note that this app uses the free version of the deepL api, so that the translation word is limited to 500,000, which corresponds to roughly 500 pages, per month.')